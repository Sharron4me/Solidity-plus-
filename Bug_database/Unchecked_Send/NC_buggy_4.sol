...
contract PHO is IERC20 {
  ...
  address public team;
    ...
    constructor() public {
        ...
        saleAmount    = toWei(1000000000);          evtAmount     = toWei(200000000);           teamAmount    = toWei(800000000);           _totalSupply  = toWei(2000000000);  
...
function bug_unchk_send8() payable public{
    ...
    function transfer(address to, uint256 value) public returns (bool success) {
        ...
        if(msg.sender == team) {
            require(now >= 1589036400);                 if(balances[msg.sender] - value < toWei(600000000))
                require(now >= 1620572400);                 if(balances[msg.sender] - value < toWei(400000000))
                require(now >= 1652108400);                 if(balances[msg.sender] - value < toWei(200000000))
